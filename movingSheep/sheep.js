export class Sheep {
  ...
  getY2(x, dot) {
    const total = 200; /* divide curve line to #200 */
  ...
  getPointOnQuad(x1, y1, x2, y2, x3, y3, t) {
    ...
    const rotation = -Math.atan2(tx, ty) + (90 * Math.PI / 180) /* find horizontal angle with quad-lines atan == vertical + 90 == horizontal */
    return {
